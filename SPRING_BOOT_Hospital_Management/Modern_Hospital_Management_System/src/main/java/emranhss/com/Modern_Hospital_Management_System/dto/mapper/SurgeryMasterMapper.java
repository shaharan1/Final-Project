...
public class SurgeryMasterMapper {
    ...
    private void applyRequest(SurgeryMaster master, SurgeryMasterRequest request, SurgeryCategory category) {
        ...
        master.setSurgeonFee(request.getSurgeonFee());
        master.setAssistantSurgeonFee(request.getAssistantSurgeonFee());
        ...
        master.setWardCabinCharge(request.getWardCabinCharge());
        master.setMedicineCharge(request.getMedicineCharge());
        master.setLaboratoryCharge(request.getLaboratoryCharge());
        master.setRadiologyCharge(request.getRadiologyCharge());
    ...
    public SurgeryMasterResponse toResponse(SurgeryMaster master) {
        ...
        response.setSurgeonFee(master.getSurgeonFee());
        response.setAssistantSurgeonFee(master.getAssistantSurgeonFee());
        ...
        response.setWardCabinCharge(master.getWardCabinCharge());
        response.setMedicineCharge(master.getMedicineCharge());
        response.setLaboratoryCharge(master.getLaboratoryCharge());
        response.setRadiologyCharge(master.getRadiologyCharge());
