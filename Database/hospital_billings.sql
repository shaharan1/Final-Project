...
CREATE TABLE `billings` (
  ...
  `meal_cost` double DEFAULT NULL,
  `medicine_cost` double DEFAULT NULL,
  `other_charge` double DEFAULT NULL,
  `test_cost` double DEFAULT NULL,
  `total_cost` double DEFAULT NULL,
  `ward_cost` double DEFAULT NULL,
  `admitted_patient_id` bigint NOT NULL,
  `id` bigint NOT NULL AUTO_INCREMENT,
  `last_updated` datetime(6) NOT NULL,
  `billing_status` varchar(20) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `UKe21rnq4sd8bwqy58jcop1ntgr` (`admitted_patient_id`),
  CONSTRAINT `FKaqmpb2la7v5u428dvukyjfq0w` FOREIGN KEY (`admitted_patient_id`) REFERENCES `admitted_patients` (`id`)
