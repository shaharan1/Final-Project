...
export class PrescriptionListComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    // Doctors see only their own prescriptions. Other staff members
    // (Admin, Pharmacist, Nurse) are allowed by the route guard and should
    // see all prescriptions instead of relying on a (doctor-only) profile.
    if (user.role === 'Doctor') {
